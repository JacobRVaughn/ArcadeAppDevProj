...
function drawHUD() {
  ...
  ctx.font = "18px Arial";
  ctx.textAlign = "left";
  ctx.fillText(`Target: ${state.target}`, 16, 26);
  ctx.fillText(`Current: ${state.current}`, 16, 52);

  ctx.textAlign = "right";
  ctx.fillText(`Rounds: ${state.rounds}`, W - 16, 26);
  ctx.textAlign = "left";
}
